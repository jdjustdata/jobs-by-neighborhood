...
var ScrollPosStyler = (function(document, window) {
  ...
  function updateElements(elementsToUpdate) {
    ...
    for (var i = 0; elementsToUpdate[i]; ++i) { // chrome workaround
      ...
      // add/remove style / class to element
      // my personal modification to the js function -- to animate transition
      // *** IMPORTANT ***
      // requires all elements with an sps class have an unique id
      $("#" + map.element.id).switchClass(map.removeClass, map.addClass, 1000, "swing");
